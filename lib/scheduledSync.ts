...
import { terminateVPNSessionsForUser, getActiveVPNSessions } from "./fortigateVPN"
...
async function syncUsers() {
  try {
    ...
    if (hasChanges) {
      ...
      console.log(`ℹ️ No se detectaron cambios, no se registró evento de sincronización`)
    }
  } catch (error) {
