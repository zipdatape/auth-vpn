...
import { Home, Users, Shield, Calendar, LogOut, FileText, User } from "lucide-react"
  ...
  return (
    <aside className="bg-gray-800 text-white w-64 p-6">
      ...
      <nav className="space-y-2">
        ...
        <Link href="/my-profile" className="flex items-center hover:bg-gray-700 p-2 rounded">
